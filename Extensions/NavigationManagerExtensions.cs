...
namespace TripTracker.Extensions
{
    public static class NavigationManagerExtensions
    {

        public static string GetCurrentPageUrl(this NavigationManager navigationManager) => $"/{navigationManager.Uri.Replace(navigationManager.BaseUri, "").TrimStart('/')}";
